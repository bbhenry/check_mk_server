...
#foreach ($DS as $i) {
    ...
    if(preg_match('/^connection_time$/', $NAME[$i])) {
        ...
        $def[$defcnt] .= "AREA:connectiontime#FF4571 ";
    ...
    if(preg_match('/^index_usage$/', $NAME[$i])) {
        ...
        $def[$defcnt] .= "CDEF:ar=indexusage,$CRIT_MIN[$i],LE,indexusage,0,GT,INF,UNKN,IF,UNKN,IF,ISINF,indexusage,0,IF ";
        $def[$defcnt] .= "CDEF:ay=indexusage,$WARN_MIN[$i],LE,indexusage,$CRIT_MIN[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,indexusage,0,IF ";
        $def[$defcnt] .= "CDEF:ag=indexusage,100,LE,indexusage,$WARN_MIN[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,indexusage,0,IF ";
        $def[$defcnt] .= "AREA:ag#$green: " ;
        $def[$defcnt] .= "AREA:ay#$yellow: " ;
        $def[$defcnt] .= "AREA:ar#$red: " ;
        $def[$defcnt] .= "LINE:indexusage#FF4571:\" \" ";
        $def[$defcnt] .= "VDEF:vindexusage=indexusage,LAST " ;
        $def[$defcnt] .= "GPRINT:vindexusage:\"Index usage (since epoch) is %3.2lf percent\\n\" " ;

        $def[$defcnt] .= "DEF:indexusagenow=$RRDFILE[2]:$DS[2]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^bufferpool_hitrate$/', $NAME[$i])) {
        ...
        $def[$defcnt] .= "CDEF:ar=hitrate,$CRIT_MIN[$i],LE,hitrate,0,GT,INF,UNKN,IF,UNKN,IF,ISINF,hitrate,0,IF ";
        $def[$defcnt] .= "CDEF:ay=hitrate,$WARN_MIN[$i],LE,hitrate,$CRIT_MIN[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,hitrate,0,IF ";
        $def[$defcnt] .= "CDEF:ag=hitrate,100,LE,hitrate,$WARN_MIN[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,hitrate,0,IF ";
        $def[$defcnt] .= "AREA:ag#$green: " ;
        $def[$defcnt] .= "AREA:ay#$yellow: " ;
        $def[$defcnt] .= "AREA:ar#$red: " ;
        $def[$defcnt] .= "LINE1.5:hitrate#FF4571:\" \" ";
        $def[$defcnt] .= "VDEF:vhitrate=hitrate,LAST " ;
        $def[$defcnt] .= "GPRINT:vhitrate:\"Hitratio (since epoch) is %3.2lf percent \\n\" ";

        $def[$defcnt] .= "DEF:hitratenow=$RRDFILE[2]:$DS[2]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^bufferpool_free_waits_rate$/', $NAME[$i])) {
        ...
        $def[$defcnt] .= "AREA:logwait#FF4571 ";
    ...
    if(preg_match('/^qcache_hitrate$/', $NAME[$i])) {
        ...
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:sps=$RRDFILE[3]:$DS[3]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^tablelock_contention$/', $NAME[$i])) {
        ...
        $def[$defcnt] .= "CDEF:ag=tbllckcont,$WARN[$i],LE,tbllckcont,0,GT,INF,UNKN,IF,UNKN,IF,ISINF,tbllckcont,0,IF ";
        $def[$defcnt] .= "CDEF:ay=tbllckcont,$CRIT[$i],LE,tbllckcont,$WARN[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,tbllckcont,0,IF ";
        $def[$defcnt] .= "CDEF:ar=tbllckcont,100,LE,tbllckcont,$CRIT[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,tbllckcont,0,IF ";
        $def[$defcnt] .= "AREA:ag#$green: " ;
        $def[$defcnt] .= "AREA:ay#$yellow: " ;
        $def[$defcnt] .= "AREA:ar#$red: " ;
        $def[$defcnt] .= "LINE:tbllckcont#FF4571:\" \" ";
        $def[$defcnt] .= "VDEF:vtbllckcont=tbllckcont,LAST " ;
        $def[$defcnt] .= "GPRINT:vtbllckcont:\"Lock contention (since epoch) is %3.2lf%%\\n\" " ;

        $def[$defcnt] .= "DEF:tbllckcontnow=$RRDFILE[2]:$DS[2]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^tablecache_hitrate$/', $NAME[$i])) {
        ...
        $def[$defcnt] .= "AREA:ay#$yellow: " ;
        $def[$defcnt] .= "AREA:ar#$red: " ;
        $def[$defcnt] .= "LINE:hitrate#FF4571:\" \" ";
        $def[$defcnt] .= "VDEF:vhitrate=hitrate,LAST " ;
    ...
    if(preg_match('/^pct_tmp_table_on_disk$/', $NAME[$i])) {
        ...
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:tmptbldsk=$RRDFILE[$i]:$DS[$i]:AVERAGE:reduce=LAST " ;
        $def[$defcnt] .= "CDEF:ag=tmptbldsk,$WARN[$i],LE,tmptbldsk,0,GT,INF,UNKN,IF,UNKN,IF,ISINF,tmptbldsk,0,IF ";
        $def[$defcnt] .= "CDEF:ay=tmptbldsk,$CRIT[$i],LE,tmptbldsk,$WARN[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,tmptbldsk,0,IF ";
        $def[$defcnt] .= "CDEF:ar=tmptbldsk,100,LE,tmptbldsk,$CRIT[$i],GT,INF,UNKN,IF,UNKN,IF,ISINF,tmptbldsk,0,IF ";
        $def[$defcnt] .= "AREA:ag#$green: " ;
        $def[$defcnt] .= "AREA:ay#$yellow: " ;
        $def[$defcnt] .= "AREA:ar#$red: " ;
        $def[$defcnt] .= "LINE:tmptbldsk#FF4571:\" \" ";
        ...
        $def[$defcnt] .= "DEF:tmptbldsknow=$RRDFILE[2]:$DS[2]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^threads_connected$/', $NAME[$i])) {
        ...
        $def[$defcnt] .= "AREA:threads#FF4571 ";
    ...
    if(preg_match('/^slave_lag$/', $NAME[$i])) {
        ...
        $opt[$defcnt] = "--vertical-label \"Seconds\" --title \"Slave Lag on $hostname\" ";
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:slavelag=$RRDFILE[$i]:$DS[$i]:AVERAGE:reduce=LAST " ;
        $def[$defcnt] .= "AREA:slavelag#FF4571:\" \" ";
        $def[$defcnt] .= "VDEF:vslavelag=slavelag,LAST " ;
        $def[$defcnt] .= "GPRINT:vslavelag:\"Slave Lag is %3.2lf Seconds Behind \\n\" " ;
        $defcnt++;
    }
    if(preg_match('/^pending_agi_count$/', $NAME[$i])) {
        $ds_name[$defcnt] = "Pending AGI Count";
        $opt[$defcnt] = "--vertical-label \"Count\" --title \"Pending AGI Count on $hostname\" ";
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:pendingagi=$RRDFILE[$i]:$DS[$i]:AVERAGE:reduce=LAST " ;
        $def[$defcnt] .= "AREA:pendingagi#FF4571:\" \" ";
        $def[$defcnt] .= "VDEF:vpendingagi=pendingagi,LAST " ;
        $def[$defcnt] .= "GPRINT:vpendingagi:\"Pending AGI Count is %.0lf \\l\" " ;
        $defcnt++;
    }
?>
